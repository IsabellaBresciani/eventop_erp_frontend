...
import {
  loadHostAccountSettings,
  saveHostAccountSettings,
  type AccountSettings,
} from '../../data/host-account-settings'
import { useHostSession } from '../../hooks/useHostSession'

export default function HostAccountSettingsPage() {
  const { session } = useHostSession()
  const [settings, setSettings] = useState<AccountSettings>(() => {
    const stored = loadHostAccountSettings()
    return {
      ...stored,
  ...
  const handleSave = () => {
    saveHostAccountSettings(settings)
    setSaved(true)
