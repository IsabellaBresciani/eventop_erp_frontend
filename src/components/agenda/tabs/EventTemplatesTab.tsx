    ...
    <div className="space-y-6">
      ...
      >
        ...
        <div className="mt-5 rounded-xl bg-primary/5 p-4">
          <p className="text-xs font-medium text-primary">Impacto en el calendario</p>
          <p className="mt-1 text-xs text-slate-600">
            Al seleccionar "Boda / XV" en el calendario, el sistema reserva automáticamente{' '}
            {settings.eventTemplates.find((t) => t.name.includes('Boda'))?.durationHours ?? 8} horas
            + {settings.bufferHours}h de buffer de limpieza.
          </p>
        </div>
      </SettingsCard>

      <SettingsCard title="Vista previa de bloques" description="Cómo se verán los bloques en el calendario.">
