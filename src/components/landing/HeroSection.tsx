        ...
        <div className="mx-auto max-w-4xl text-center">
          <FadeIn>
            <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-primary/20 bg-primary/5 px-4 py-1.5 text-sm font-medium text-primary">
              ...
              ERP + Marketplace para salones de eventos
            </div>
          </FadeIn>
          ...
          <FadeIn delay={0.2}>
            <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-slate-600 sm:text-xl">
              El ecosistema digital que une tu ERP con un Marketplace profesional.
              Gestiona eventos, presupuestos e invitaciones desde un solo lugar — y
              deja de perder consultas en WhatsApp.
            </p>
          </FadeIn>

          <FadeIn delay={0.3}>
            <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
              <button type="button" onClick={onOpenRegister} className="btn-primary px-8 py-4 text-base">
                Comenzar Prueba Gratis
                <ArrowRight className="h-4 w-4" />
              </button>
              <button type="button" onClick={onOpenLogin} className="btn-secondary px-8 py-4 text-base">
          ...
          <FadeIn delay={0.4}>
            <p className="mt-4 text-sm text-slate-400">
              Sin tarjeta de crédito · Configuración en 15 minutos · Soporte en español
            </p>
          </FadeIn>
        </div>
          ...
          <div className="relative mx-auto max-w-5xl">
            ...
            <div className="relative overflow-hidden rounded-card border border-surface-border bg-white shadow-card-hover">
              <div className="flex items-center gap-2 border-b border-surface-border bg-surface/50 px-4 py-3">
                ...
                <span className="ml-2 text-xs text-slate-400">panel.eventop.com</span>
              </div>
  ...
  return (
    <div>
      <div className="mb-3 flex items-center justify-between">
        <span className="text-sm font-semibold text-slate-700">Agosto 2026</span>
        <div className="flex gap-3 text-[10px] text-slate-400">
          <span className="flex items-center gap-1">
            <span className="h-2 w-2 rounded-full bg-blue-500" /> Presupuestado
          </span>
          <span className="flex items-center gap-1">
